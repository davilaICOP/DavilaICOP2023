...
public class InfoEscrutinioProvisorio {
    private JFrame framePrincipal;

    public InfoEscrutinioProvisorio(Sistema sistema, JFrame frame) {
        this.framePrincipal = frame;

        // Generar el contenido del escrutinio provisorio
        String contenidoEscrutinio = generarContenidoEscrutinio(sistema);

        // Etiqueta para el título centrado
        JLabel lblTitulo = new JLabel("Escrutinio Provisorio:");
